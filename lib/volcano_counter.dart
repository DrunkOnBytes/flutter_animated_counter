...
class _EruptionState extends State<_Eruption>
...
class _EruptionPainter extends CustomPainter {
  _EruptionPainter(this.animation, this.particles)
      : random = math.Random(),
